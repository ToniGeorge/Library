...
class read implements Runnable {
    ...
    public void run() {
        Gson gson = new Gson();
        Type type = new TypeToken<ArrayList<Borrower>>() {
        }.getType();
        ...
        type = new TypeToken<ArrayList<borrowItem>>() {
        }.getType();
        json = gson.toJson(Library.librarians, type);
        try {
...
class write implements Runnable {
    ...
    public void run() {
        ...
        Type type2 = new TypeToken<ArrayList<borrowItem>>() {
        }.getType();
...
public class Library extends Application {
        ...
        for (Book book : bookList) {
            ...
            for (int i = 0; i < title.length() - str.length() + 1; i++) {
                ...
                for (int j = 0; j < str.length(); j++) {
                    if (str.charAt(j) == title.charAt(i + j) || str.charAt(j) == title.charAt(i + j) - 32) {
                        cnt++;
                    }
                    if (cnt == str.length()) {
                        cnt = -1;
    ...
    public void start(Stage stage) throws Exception {
        ...
        Book b = new Book("The Three Musketeers", "Alexandre Dumas", "", "1", "Fiction", "El DIwan books", "threemusket.jpg");
        Book b1 = new Book("Harry Potter and The Prisoner of Azkaban", "JK Rowling", hpdes, "2", "Fantasy", "Antoun books", "hp.jpg");
        Book b2 = new Book("Treasure Island", "Robert Louis Stevenson", tresdes, "3", "Fiction", "Toni books", "tres.jpg");
        Book b3 = new Book("Seven Habits of Highly Effective People", " Stephen R. Covey", sevdes, "4", "Self-Help", "Antoun books", "seven.jpg");
        Book b4 = new Book("Les Miserables", "Victor Hugo", mesdes, "5", "Fiction", "Toni books", "lesmes_.jpg");
        Book b5 = new Book("Harry Potter and the Philosopher's Stone", "J.K Rowling", hp1des, "6", "Fantasy", "Antoun Books", "hp1.jpg");
        Book b6 = new Book("Harry Potter and the Chamber of Secrets", "J.K Rowling", hp2des, "7", "Fantasy", "El diwan Books", "hp2.jpg");
        Book b7 = new Book("Harry Potter and the Goblet of Fire", "J.K Rowling", hp4des, "8", "Fantasy", "El diwan Books", "hp4.jpg");
        Book b8 = new Book("Harry Potter and the Order of the Phoenix", "J.K Rowling", hp5des, "9", "Fantasy", "El diwan Books", "hp5.jpg");
        Book b9 = new Book("Harry Potter and the Half Blood Prince", "J.K Rowling", hp6des, "10", "Fantasy", "El diwan Books", "hp6.jpg");
        Book b10 = new Book("Harry Potter and the Deathly Hallows", "J.K Rowling", hp7des, "11", "Fantasy", "El Diwan Books", "hp7.jpg");
        Book b11 = new Book("The Da Vinci Code", "Dan Brown", davinci, "12", "Thriller", "El Diwan Books", "davinci.jpg");
        Book b12 = new Book("The Lost Symbol", "Dan Brown", symbol, "13", "Thriller", "EL diwan Books", "symbol.jpg");
        Book b13 = new Book("Men are from Mars, Women are from Venus", "John Gray", women, "14", "Self-Help", "Antoun Books", "women.jpg");
        Book b14 = new Book("Why Mars and Venus Collide", "John Gray", women2, "15", "Self-Help", "Toni Books", "women2.jpg");
        Book b15 = new Book("Tuesdays with Morrie", "Mitch Albom", morrie, "16", "Biography", "Antoun Books", "morrie.jpg");
        Book b16 = new Book("The Time Keeper", "Mitch Albom", time, "17", "Fiction", "Toni Books", "TimeKeeper.jpg");
        Book b17 = new Book("A Thousand Splendid Suns", "Khaled Hosseini", splendid, "18", "Drama", "Antoun Books", "splendid.jpg");
        Book b18 = new Book("The Kite Runner", "Khaled Hosseini", kite, "19", "Drama", "Toni Books", "The Kite Runner.jpe");
        Book b19 = new Book("IT", "Stephen King", it, "20", "Thriller", "Antoun Books", "IT.jpg");
        Book b20 = new Book("I Am Malala", "Malala Yousafzai", malala, "21", "Biography", "Toni Books", "malala.jpg");
        Book b21 = new Book("The Diary of a Young Girl", "Anne Frank", anne, "22", "Biography", "Antoun Books", "anne frank.jpg");
        Book b22 = new Book("The Girl with the Dragon Tattoo", "Stieg Larsson", tattoo, "23", "Thriller", "Toni Books", "tattoo.jpg");


        Borrower l1 = new Borrower("Toni", "George", "15/9/1995", "toni@gmail.com","2","toni","123");
